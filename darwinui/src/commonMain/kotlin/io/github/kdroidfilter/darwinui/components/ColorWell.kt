...
object ColorWellDefaults {
    ...
    @Composable
    fun colors(
        borderColor: Color = DarwinTheme.colorScheme.borderStrong.copy(alpha = 0.35f),
        disabledBorderColor: Color = DarwinTheme.colorScheme.borderStrong.copy(alpha = 0.15f),
    ) = ColorWellColors(borderColor, disabledBorderColor)
}
