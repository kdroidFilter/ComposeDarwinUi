...
import io.github.kdroidfilter.darwinui.components.PageControl
import io.github.kdroidfilter.darwinui.components.PageControlDefaults
    ...
    Column(
        ...
        PageControl(
            ...
            colors = PageControlDefaults.colors(
                backgroundColor = DarwinTheme.colorScheme.textPrimary.copy(alpha = 0.08f),
            ),
        )
    }
}
